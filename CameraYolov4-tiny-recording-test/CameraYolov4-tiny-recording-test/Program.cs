...
namespace CameraRpiYolov3_tiny
{
    /// <summary>
    /// OpenCvSharp V4 with YOLO v4
    ...
    class Program
    {
        ...
        private const string Cfg = "yolov4-tiny.cfg";

        //https://pjreddie.com/media/files/yolov3.weights
        private const string Weight = "yolov4-tiny.weights";

        //https://github.com/pjreddie/darknet/blob/master/data/coco.names
        private const string Names = "coco.names";

        //file location
        private static readonly string Location = $".{Path.DirectorySeparatorChar}Content{Path.DirectorySeparatorChar}";
